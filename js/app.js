...
(function defineMenuData() {
  ...
  window.BONO.menuData = [
    ...
    /* ---------- Prasmanan ---------- */
    {
      id: 'prasmanan-1',
      category: 'prasmanan',
      name: 'Paket Prasmanan Hemat 1 (20 - 50 Porsi)',
      desc: 'Sop Bakso, Kentang Ati, Rendang, Sambal, Kerupuk, Nasi.<br><br><strong>*Harga & porsi belum fix, hubungi admin via WA untuk detail.</strong>',
    ...
    },
    {
      id: 'prasmanan-2',
      category: 'prasmanan',
      name: 'Paket Prasmanan Komplet 1 (20 - 50 Porsi)',
      desc: 'Nasi, Ayam Goreng, Kentang Mustofa, Sayur Asem, Ikan Asin, Sambal, Kerupuk.<br><br><strong>*Harga & porsi belum fix, hubungi admin via WA untuk detail.</strong>',
    ...
    },
    {
      id: 'prasmanan-3',
      category: 'prasmanan',
      name: 'Paket Prasmanan Spesial 1 (20 - 50 Porsi)',
      desc: 'Nasi, Capcay, Beef Teriyaki, Kentang Ati, Sambal, Kerupuk.<br><br><strong>*Harga & porsi belum fix, hubungi admin via WA untuk detail.</strong>',
      price: rupiah(1500000),
      popular: false,
    ...
    },
    {
      id: 'prasmanan-4',
      category: 'prasmanan',
      name: 'Paket Prasmanan Hemat 2 (20 - 50 Porsi)',
      desc: 'Sop Bakso, Kentang Ati, Rendang, Sambal, Kerupuk, Nasi, Es Campur, Melon/Semangka.<br><br><strong>*Harga & porsi belum fix, hubungi admin via WA untuk detail.</strong>',
    ...
    },
    {
      id: 'prasmanan-5',
      category: 'prasmanan',
      name: 'Paket Prasmanan Komplet 2 (20 - 50 Porsi)',
      desc: 'Nasi, Ayam Goreng, Kentang Mustofa, Sayur Asem, Ikan Asin, Sambal, Kerupuk, Es Kuwut, Melon/Semangka.<br><br><strong>*Harga & porsi belum fix, hubungi admin via WA untuk detail.</strong>',
      price: rupiah(1800000),
      popular: false,
    ...
    }, 
    {
      id: 'prasmanan-6',
      category: 'prasmanan',
      name: 'Paket Prasmanan Spesial 2 (20 - 50 Porsi)',
      desc: 'Nasi, Capcay, Beef Teriyaki, Kentang Ati, Sambal, Kerupuk, Es Cendol, Melon/Semangka.<br><br><strong>*Harga & porsi belum fix, hubungi admin via WA untuk detail.</strong>',
      price: rupiah(1800000),
      popular: false,
